...
public class Telaverificaexclusao extends javax.swing.JFrame {

   public Telaverificaexclusao() {
    initComponents();
    ...
    if (loginSucesso) {
        ...
        Exlcuirfuncionarios telexclude = new Exlcuirfuncionarios();
        telexclude.setVisible(true);
        dispose();
    } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Telaverificaexclusao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Telaverificaexclusao().setVisible(true);
        });
    }
